...
<body>
	<div id="sessionID" style="display:none"><?php session_start();echo $_SESSION["player"]; ?></div>
	<div id="sessionPlayer" style="display:none">vendeur</div>
	<div id="finTranche"style="display:none">
			<div class="messageFin" >
				...
				<a class="report" href=<?php echo "lib/php/Jasper.php?page_name=vendeur&id_player=".$_SESSION["player"]; ?> target="_blank"></a>
...
<div id="body">
	...
	<div class="wrapper noselect">
		...
		<a class="rapport" href=<?php echo "lib/php/Jasper.php?page_name=vendeur&id_player=".$_SESSION["player"]; ?> target="_blank"></a>
		<div class="Bra7">
			<div class="slogon idd">
				<input class="texSlogon idd" type="text" name="slogon" placeholder="Slogon">
				<div class="micro idd"><img src="pictures/broadcast.png"></div>
			</div>
			<div class="validate idd"></div>
...
<div id="rapport_id"></div>
		...
		<script src="lib/js/jquery-ui-touch.js"></script>
		<script src="lib/js/popup.js"></script>
		<script src="lib/js/socket.io.js"></script>
		<script src="lib/js/chat.js"></script>
		<script src="lib/js/vendeur.js"></script>
